...
µWebSockets.js is a standards-compliant web server written in 10,000 lines of C++. It is exposed to Node.js as a simple-to-use, native V8 addon and has significantly outperformed all alternatives for Node.js since 2016. Bun is heavily derived from uWS; its event-loop, TLS, HTTP, QUIC, WebSockets, pub/sub, and URL routing are all forked from uWS<sup>[[4]](https://github.com/oven-sh/bun/tree/main/packages/bun-uws/src)</sup><sup>[[5]](https://github.com/oven-sh/bun/tree/main/packages/bun-usockets/src)</sup>. That's why [uWS.js performs very similarly to Bun](https://http-arena.com) and has a similar interface and feature-set, while being far more stable & conservative.
