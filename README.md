...
* We *recommend, for simplicity* installing with `bun install uNetworking/uWebSockets.js#v20.40.0` or any such [release](https://github.com/uNetworking/uWebSockets.js/releases). Use [official builds](https://nodejs.org/en/download) of Node.js LTS.
