...
Install with `npm install uNetworking/uWebSockets.js#v17.2.0` or any such [release](https://github.com/uNetworking/uWebSockets.js/releases). No compiler needed.
