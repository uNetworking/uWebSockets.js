...
void build_lsquic(const char *arch) {
    ...
    run("cd uWebSockets/uSockets/lsquic && cmake -DCMAKE_C_FLAGS="/I..\\..\\..\\zlib-1.3.1" -DZLIB_INCLUDE_DIR=..\..\..\zlib-1.3.1 -DCMAKE_POSITION_INDEPENDENT_CODE=ON -DBORINGSSL_DIR=../boringssl -DCMAKE_BUILD_TYPE=Release -DLSQUIC_BIN=Off . && msbuild ALL_BUILD.vcxproj");
#endif
}
