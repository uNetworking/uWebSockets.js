...
Install with `npm install uNetworking/uWebSockets.js#v16.1.0` or any such [release](https://github.com/uNetworking/uWebSockets.js/releases). No compiler needed.
